...
function Signup() {
  return (
    <>
      <h2 className="animate-fadeInUp font-bold text-2xl max-sm:text-xl">Create Your Account</h2>
      ...
      <form className="mt-6">
        ...
        <p className="max-sm:text-[10px] ml-1 mt-1 text-red-600 text-xs hidden username-alert">
        ...
        <p className="max-sm:text-[10px] ml-1 mt-1 text-red-600 text-xs hidden email-alert">
          Enter a valid Email!
        </p>
        <div className="animate-fadeInUp relative mt-2 flex items-center bg-input-bg text-text-secondary border-2 border-input-border/50 rounded-xl h-14 focus-within:border-input-border-focus transition-colors duration-300">
        ...
        <p className="max-sm:text-[10px] ml-1 mt-1 text-red-600 text-xs hidden password-alert">
