...
function Login() {
  ...
  return (
    <>
      <h2 className="font-bold text-2xl max-sm:text-xl">Welcome Back</h2>
      ...
      <form className="mt-7">
        ...
        <div className="relative mt-2 flex items-center bg-input-bg text-text-secondary border-2 border-input-border/50 rounded-xl h-14 focus-within:border-input-border-focus transition-colors duration-300">
          ...
          <input
            ...
            type="password"
          />
          <button type="button" className="absolute right-2 cursor-pointer text-text-secondary hover:text-text-primary transition-colors duration-300 show-password">
        ...
        <button
          className="font-bold max-sm:text-xs text-sm mt-4 text-center w-full h-12 rounded-xl bg-cta-primary hover:bg-cta-hover transform-colors duration-300 cursor-pointer disabled:bg-cta-primary/40 disabled:cursor-default login-btn"
          type="button"
        >
          Login
        </button>
