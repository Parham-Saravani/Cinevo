...
function Banner({banner , bannerDescription , duration , genres , rating , releaseYear , slug , title}) {
  return (
    <>
      <img
        ...
        <div className="container mx-auto">
          <div className="top-0 max-md:top-8 bottom-0 my-auto absolute h-fit">
            ...
            <div className="mt-5 flex">
              <a href="" className="flex max-md:gap-1 gap-2 items-center justify-center bg-cta-primary hover:bg-cta-hover text-text-primary font-semibold w-45 max-md:w-fit text-sm max-md:text-[10px] max-md:px-3 py-3 max-md:py-0 transition-colors duration-300 cursor-pointer rounded-xl" >
            ...
            <div className="mt-4 flex flex-wrap items-center text-sm max-md:text-xs">
              <p className="relative mx-4 flex gap-1 items-center text-text-secondary banner-data">
                <FaStar className="size-4 fill-yellow-500" />{rating}/10
              </p>
              <p className="relative mx-4 text-text-secondary banner-data">
                ${releaseYear}
              </p>
              <p className="relative mx-4 text-text-secondary banner-data"></p>
            </div>
          </div>
        </div>
      </div>
