...
function ErrorPage() {
  ...
  return (
    <main className="animate-fadeIn min-h-screen flex items-center justify-center px-5">
      <div className="w-full *: text-center">
        {location.state.hideStatusCode ? null : (
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-text-secondary">
          {location.state.desc
            ? location.state.desc
            : "We couldn't find the movie or series you're looking for. It may have been removed, renamed, or the link may be incorrect."}
        </p>
